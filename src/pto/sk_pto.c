...
sk_proto_t sk_pto_tbl[] = {
    ...
    {SK_PTO_SERVICE_IOCALL,        SK_PTO_PRI_6, &sk_pto_srv_iocall},
    {SK_PTO_SERVICE_TASK_RUN,      SK_PTO_PRI_6, &sk_pto_srv_task_run},
    {SK_PTO_SERVICE_TASK_COMPLETE, SK_PTO_PRI_6, &sk_pto_srv_task_complete},
