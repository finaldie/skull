...
extern sk_driver_opt_t sk_driver_app;
extern sk_driver_opt_t sk_driver_std;
...
sk_driver_t* sk_driver_create(sk_engine_t* engine, sk_workflow_t* workflow) {
    ...
    switch (driver->type) {
    case SK_DRIVER_APP:
        driver->opt = sk_driver_app;
        break;
    case SK_DRIVER_STD:
        driver->opt = sk_driver_std;
        break;
    case SK_DRIVER_TCP:
