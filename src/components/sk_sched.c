...
int _run_event(sk_sched_t* sched, sk_io_t* io, sk_event_t* event)
{
    ...
    if (sk_entity_status(entity) != SK_ENTITY_ACTIVE) {
        ...
        printf("entity(%d) status=%d, will be deleted\n",
               event->fd,
